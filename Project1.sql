...
SELECT 
emp.*,
msg.first_name || ' ' || msg.last_name AS manager,
CASE 
	WHEN
	...
	END AS is_active
FROM
employees emp LEFT JOIN employees msg
ON emp.manager_id = msg.emp_id;
...
ROUND(SUM(salary) OVER(ORDER BY start_date),2) as running_total_of_salary
FROM employees;
